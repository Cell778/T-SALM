...
# python datasim/audio_simulation.py --dataset=Clotho --dataset_type=train
# python datasim/audio_simulation.py --dataset=Clotho --dataset_type=valid
# python datasim/audio_simulation.py --dataset=Clotho --dataset_type=test
